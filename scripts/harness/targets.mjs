...
export const TARGET_CAPABILITIES = Object.freeze({
  ...
  'grok-build': { instructions: '.grok/rules', skills: '.grok/skills', hooks: 'unsupported', mcp: 'native-project-cli', mcpConfig: '.grok/config.toml' },
...
export function targetPlan({ target } = {}) {
  ...
  return { target, status: 'pass', reason: 'ok', capabilities, onepassword: target === 'antigravity' ? 'incompatible' : 'command-only', workflow: 'apm.yml' };
}
