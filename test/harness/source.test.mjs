...
function lockFor(path, contents) {
  return { schemaVersion: 1, repository: 'kyoneken/coding-agent-harness', ref: 'f26054f6256e10a107d800d2023defa94f2f71a7', files: [{ path, sha256: createHash('sha256').update(contents).digest('hex') }] };
}
